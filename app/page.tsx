        ...
        <div className="section-container relative z-10 text-white">
          <ScrollReveal direction="right">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="/egyots-brochure.pdf" download="EGYOTS-Brochure.pdf" className="btn-outline-white btn-lg flex items-center gap-2">
        ...
        <div className="section-container py-0 text-center">
          <ScrollReveal>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="/egyots-brochure.pdf" download="EGYOTS-Brochure.pdf" className="btn-outline btn-lg flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                Download Brochure
              </a>
            </div>
